# -*- coding: utf-8 -*-
"""
Created on Fri Oct 25 09:08:28 2019
...
import os
#回归方差(反应自变量与因变量之间的相关程度);平均绝对误差;均方差;中值绝对误差;R平方值
...
'''Modify no.3'''
out_dir = r'E:\Single_station\Data\Methods\{}\RF_new\ET\{}'.format(station,year)+'\\'
out_dir1 = r'E:\Single_station\Data\Methods\{}\RF_new\ET\ET_ave_{}.csv'.format(station,year)
